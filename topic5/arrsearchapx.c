...
//  (a) Begin the definition of a function called find_query
...
int find_query(double values[], int num_vals, double query, double tol) {
...
int main(void)
{
    ...
    int result = find_query(items, array_size, query, error);
